...
| System: single-source | Claude skill | 12 steps | Full CLI lifecycle (import→refresh→ids→force→verify) |
| System: double-source | Claude skill | 15 steps | Multi-source layout, SQLite, edge cases |
| **Total** | **8 test files + 2 skills** | **178 unit + 27 system steps** | |
...
│  - incremental sync          - cross-source relations   │
│                                                         │
